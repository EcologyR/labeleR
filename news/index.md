...
- Function `fill_NAs_df` created and implemented in functions to allow
  empty cells ([\#62](https://github.com/EcologyR/labeleR/issues/62)).

## labeleR 0.1.1

- Function `create_tinylabel` renamed as `create_tiny_label` for
  consistency ([\#57](https://github.com/EcologyR/labeleR/issues/57)).
