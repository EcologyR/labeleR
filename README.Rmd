...
```{r email list, include = FALSE}
students.table <- data.frame(
  "Names" = c("Harry Potter", "Hermione Granger", "Neville Longbottom", "Ginny Weasley"),
  "email" = c("h.potter@hogwarts.co.uk", "h.granger@hogwarts.co.uk",
                            "n.longbottom@hogwarts.co.uk", "g.weasley@hogwarts.co.uk"))
...
This way, every student will receive an email with their individual certificate attached.
