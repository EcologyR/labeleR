...
Article: <https://www.revistaecosistemas.net/index.php/ecosistemas/article/view/3060>.
...
If you have used labeleR and you want to share the output with the labeleR community, you can send an example to us and we will publish it in our website! Please open an issue in the labeleR [github](https://github.com/EcologyR/labeleR/issues) or write to [ig.ramosgutierrez@gmail.com](mailto:ig.ramosgutierrez@gmail.com).
