...
people_list_long <- gsheet2tbl("https://docs.google.com/spreadsheets/d/1inkk3_oNvvt8ajdK4wOkSgPoUyE8JzENrZgSTFJEFBw/edit#gid=0", sheetid = ,)
people_list_long <- as.data.frame(people_list_long)

people_list <- read_sheet("1inkk3_oNvvt8ajdK4wOkSgPoUyE8JzENrZgSTFJEFBw")
people_list <- as.data.frame(people_list)                       
...
+-----------------------------------------------------------------------+
| ![Participation certificate                                           |
| example](man/figures/Participation_certificate.png)                   |
+=======================================================================+
+-----------------------------------------------------------------------+
